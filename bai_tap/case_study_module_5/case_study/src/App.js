...
function App() {
      ...
      return (
        <div>
          ...
          <title>RedPlanet — A Onepage Hotel HTML Bootstrap Website Template by Colorlib </title>
          ...
          {/* Modal */}
          <div className="modal fade " id="reservation-form" tabIndex={-1} role="dialog" aria-labelledby="reservationFormTitle" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered" role="document">
              <div className="modal-content">
                <div className="modal-body">
                  <div className="row">
                    <div className="col-md-12" data-aos="fade-up" data-aos-delay={100}>
                      <form action="index.html" method="post" className="bg-white p-4">
                        <div className="row mb-4"><div className="col-12"><h2>Reservation</h2></div></div>
                        <div className="row">
                        ...
                        <div className="row">
                          <div className="col-md-6 form-group">
                            <label className="text-black font-weight-bold" htmlFor="checkin_date">Date Check In</label>
                            <input type="text" id="checkin_date" className="form-control" />
                          </div>
                          <div className="col-md-6 form-group">
                            <label className="text-black font-weight-bold" htmlFor="checkout_date">Date Check Out</label>
                            <input type="text" id="checkout_date" className="form-control" />
                          </div>
                        </div>
                        <div className="row">
                        ...
                        <div className="row">
                          <div className="col-md-6 form-group">
                            <input type="submit" defaultValue="Reserve Now" className="btn btn-primary text-white py-3 px-5 font-weight-bold" />
                          </div>
                        </div>
                      </form>
                    </div>
